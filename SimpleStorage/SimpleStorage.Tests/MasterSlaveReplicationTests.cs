...
namespace SimpleStorage.Tests
{
    ...
    public class MasterSlaveReplicationTests
    {
        ...
        private static IPEndPoint master = new IPEndPoint(IPAddress.Loopback, port1);

        private const int port2 = 15001;
        private static IPEndPoint slave1 = new IPEndPoint(IPAddress.Loopback, port2);

        private const int port3 = 15002;
        private static IPEndPoint slave2 = new IPEndPoint(IPAddress.Loopback, port3);
